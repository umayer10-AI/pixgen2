    ...
    return (
        <div className='border rounded-xl shadow-xl p-4 space-y-3'>
            ...
            <div className='font-semibold flex gap-5'>
                ...
                <h2 className='flex items-center gap-2'><FiDownload className='text-xl' />{p.downloads}</h2>
            </div>
            <Button className={'w-full bg-linear-to-r from-green-500 via-blue-500 bg-green-500'}>View</Button>
        </div>
    );
};
